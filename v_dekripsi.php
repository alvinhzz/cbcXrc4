      ...
      <div class="container-fluid">
       ...
       <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Dekripsi File</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="POST" action="crypto/dekripsiModel1.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputFileDekripsi" class="col-sm-2 col-form-label">File input</label>
                      <div class="col-sm-10">
                      <input type="file" class="form-control" id="inputFileDekripsi" name="inputFileDekripsi" accept=".txt" required>
                      </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer center">
                  <button type="submit" name="submit" class="btn btn-success">Dekripsi</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
              ...
              <div class="inner">
                <?php if (isset($_GET['time'])) {
                    ?>
                      ...
                      <br>
                      <form action="downloadFile/downloadDekripsi.php">
